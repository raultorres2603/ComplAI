    ...
    private String buildCatalanBlock(CityConfig cfg) {
        ...
        return String.format(
                """
                        ...
                        • Dóna respostes detallades i completes. Quan hi hagi tràmits relacionats, cita'ls pel nom i INCLOU SEMPRE l'enllaç HTML a la resposta si el context en proporciona un. És OBLIGATORI incloure l'URL quan el context el faciliti.
    ...
    private String buildSpanishBlock(CityConfig cfg) {
        ...
        return String.format(
                """
                        ...
                        • Da respuestas detalladas y completas. Cuando haya trámites relacionados, cítalos por su nombre e incluye SIEMPRE el enlace HTML en la respuesta si el contexto lo proporciona. Es OBLIGATORIO incluir la URL cuando el contexto la facilite.
    ...
    private String buildEnglishBlock(CityConfig cfg) {
        ...
        return String.format(
                """
                        ...
                        • Give detailed, complete answers. When there are related procedures, name them and ALWAYS include the HTML link in the response if the context provides one. Including the URL is MANDATORY when the context contains it.
