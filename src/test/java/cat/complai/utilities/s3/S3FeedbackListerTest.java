...
class S3FeedbackListerTest {
    ...
    @Test
    void listAllFeedbackFiles_withNoFiles_returnsEmptyList() {
        CapturingS3FeedbackLister lister = new CapturingS3FeedbackLister();
        lister.mockEntries = Collections.emptyList();
    ...
    @Test
    void listAllFeedbackFiles_withFiles_returnsEntries() {
        CapturingS3FeedbackLister lister = new CapturingS3FeedbackLister();
        lister.mockEntries = List.of(
                new FeedbackFileEntry("elprat/fb-001.json", "https://example.com/elprat/fb-001.json"),
                new FeedbackFileEntry("barcelona/fb-002.json", "https://example.com/barcelona/fb-002.json")
        );
    ...
    @Test
    void listAllFeedbackFiles_exceptionPropagatesAsRuntimeException() {
        S3FeedbackLister lister = new S3FeedbackLister() {
            @Override
            public List<FeedbackFileEntry> listAllFeedbackFiles() {
                throw new RuntimeException("S3 endpoint unreachable");
        ...
        assertThrows(RuntimeException.class, () -> lister.listAllFeedbackFiles(),
                "Lister must propagate exceptions");
    }
}