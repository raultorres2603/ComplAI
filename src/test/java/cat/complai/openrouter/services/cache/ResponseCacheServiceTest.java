...
class ResponseCacheServiceTest {
    ...
    void testStoreAndRetrieveCachedResponse() {
        ResponseCacheKey key = new ResponseCacheKey("testcity", 111, 222, QuestionCategory.PARKING, 0);
    ...
    void testReturnEmptyOnCacheMiss() {
        ResponseCacheKey key = new ResponseCacheKey("testcity", 111, 222, QuestionCategory.TAX, 0);
    ...
    void testDoNotCacheNullResponses() {
        ResponseCacheKey key = new ResponseCacheKey("testcity", 111, 222, QuestionCategory.LIBRARY, 0);
    ...
    void testDoNotCacheBlankResponses() {
        ResponseCacheKey key = new ResponseCacheKey("testcity", 111, 222, QuestionCategory.GARBAGE, 0);
    ...
    void testMultipleIndependentEntries() {
        ResponseCacheKey key1 = new ResponseCacheKey("city1", 111, 222, QuestionCategory.PARKING, 0);
        ResponseCacheKey key2 = new ResponseCacheKey("city2", 111, 222, QuestionCategory.TAX, 0);
    ...
    void testInvalidateCityEntries() {
        ResponseCacheKey key1 = new ResponseCacheKey("city1", 111, 222, QuestionCategory.PARKING, 0);
        ResponseCacheKey key2 = new ResponseCacheKey("city1", 333, 444, QuestionCategory.TAX, 0);
        ResponseCacheKey key3 = new ResponseCacheKey("city2", 111, 222, QuestionCategory.LIBRARY, 0);
    ...
    void testInvalidateAll() {
        ResponseCacheKey key1 = new ResponseCacheKey("city1", 111, 222, QuestionCategory.PARKING, 0);
        ResponseCacheKey key2 = new ResponseCacheKey("city2", 333, 444, QuestionCategory.TAX, 0);
    ...
    void testRespectMaximumCacheSize() {
        ...
        for (int i = 0; i < 10; i++) {
            ResponseCacheKey key = new ResponseCacheKey("city" + i, i, i, QuestionCategory.PARKING, 0);
    ...
    void testDifferentContextHashesIndependent() {
        ResponseCacheKey key1 = new ResponseCacheKey("city", 111, 222, QuestionCategory.PARKING, 0);
        ResponseCacheKey key2 = new ResponseCacheKey("city", 111, 999, QuestionCategory.PARKING, 0);
